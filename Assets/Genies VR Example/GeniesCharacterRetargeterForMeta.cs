...
namespace Genies.VRExample
{
    public class GeniesCharacterRetargeterForMeta : CharacterRetargeter
    {
        ...
        {
            Transform controllerRoot = transform.parent;
            ...
            // Transform centerPonytail0Dyn0 = controllerRoot.FindChildRecursive("CenterPonytail0Dyn0");
            // Transform centerPonytail0Dyn1 = controllerRoot.FindChildRecursive("CenterPonytail0Dyn1");
            // Transform centerPonytail0Dyn2 = controllerRoot.FindChildRecursive("CenterPonytail0Dyn2");
            ...
            _jointPairs = new JointPair[]
            {
                ...
                new JointPair { Joint = hipsBind, ParentJoint = hips },
                ...
                new JointPair { Joint = leftToeBaseBind, ParentJoint = leftToeBase },
                new JointPair { Joint = leftLegTwist1Bind, ParentJoint = leftLeg },
                new JointPair { Joint = leftLegTwist2Bind, ParentJoint = leftLeg },
                new JointPair { Joint = leftLegTwist3Bind, ParentJoint = leftLeg },
                new JointPair { Joint = leftUpLegTwist1Bind, ParentJoint = leftUpLeg },
                new JointPair { Joint = leftUpLegTwist2Bind, ParentJoint = leftUpLeg },
                new JointPair { Joint = leftUpLegTwist3Bind, ParentJoint = leftUpLeg },
                ...
                new JointPair { Joint = rightToeBaseBind, ParentJoint = rightToeBase },
                new JointPair { Joint = rightLegTwist1Bind, ParentJoint = rightLeg },
                new JointPair { Joint = rightLegTwist2Bind, ParentJoint = rightLeg },
                new JointPair { Joint = rightLegTwist3Bind, ParentJoint = rightLeg },
                new JointPair { Joint = rightUpLegTwist1Bind, ParentJoint = rightUpLeg },
                new JointPair { Joint = rightUpLegTwist2Bind, ParentJoint = rightUpLeg },
                new JointPair { Joint = rightUpLegTwist3Bind, ParentJoint = rightUpLeg },
                ...
                new JointPair { Joint = leftArmTwist1Bind, ParentJoint = leftArm },
                new JointPair { Joint = leftArmTwist2Bind, ParentJoint = leftArm },
                new JointPair { Joint = leftArmTwist3Bind, ParentJoint = leftArm },
                new JointPair { Joint = leftForeArm, ParentJoint = leftArm },
                new JointPair { Joint = leftForeArmTwist1Bind, ParentJoint = leftForeArm },
                new JointPair { Joint = leftForeArmTwist2Bind, ParentJoint = leftForeArm },
                new JointPair { Joint = leftForeArmTwist3Bind, ParentJoint = leftForeArm },
                ...
                new JointPair { Joint = leftHandIndex1Bind, ParentJoint = leftHandIndex1 },
                new JointPair { Joint = leftHandIndex2, ParentJoint = leftHandIndex1 },
                new JointPair { Joint = leftHandIndex2Bind, ParentJoint = leftHandIndex2 },
                new JointPair { Joint = leftHandIndex3, ParentJoint = leftHandIndex2 },
                new JointPair { Joint = leftHandIndex3Bind, ParentJoint = leftHandIndex3 },
                new JointPair { Joint = leftHandMiddle1, ParentJoint = leftHandBind },
                new JointPair { Joint = leftHandMiddle1Bind, ParentJoint = leftHandMiddle1 },
                new JointPair { Joint = leftHandMiddle2, ParentJoint = leftHandMiddle1 },
                new JointPair { Joint = leftHandMiddle2Bind, ParentJoint = leftHandMiddle2 },
                new JointPair { Joint = leftHandMiddle3, ParentJoint = leftHandMiddle2 },
                new JointPair { Joint = leftHandMiddle3Bind, ParentJoint = leftHandMiddle3 },
                new JointPair { Joint = leftHandPinky1, ParentJoint = leftHandBind },
                new JointPair { Joint = leftHandPinky1Bind, ParentJoint = leftHandPinky1 },
                new JointPair { Joint = leftHandPinky2, ParentJoint = leftHandPinky1 },
                new JointPair { Joint = leftHandPinky2Bind, ParentJoint = leftHandPinky2 },
                new JointPair { Joint = leftHandPinky3, ParentJoint = leftHandPinky2 },
                new JointPair { Joint = leftHandPinky3Bind, ParentJoint = leftHandPinky3 },
                new JointPair { Joint = leftHandRing1, ParentJoint = leftHandBind },
                new JointPair { Joint = leftHandRing1Bind, ParentJoint = leftHandRing1 },
                new JointPair { Joint = leftHandRing2, ParentJoint = leftHandRing1 },
                new JointPair { Joint = leftHandRing2Bind, ParentJoint = leftHandRing2 },
                new JointPair { Joint = leftHandRing3, ParentJoint = leftHandRing2 },
                new JointPair { Joint = leftHandRing3Bind, ParentJoint = leftHandRing3 },
                new JointPair { Joint = leftHandThumb1, ParentJoint = leftHandBind },
                new JointPair { Joint = leftHandThumb1Bind, ParentJoint = leftHandThumb1 },
                new JointPair { Joint = leftHandThumb2, ParentJoint = leftHandThumb1 },
                new JointPair { Joint = leftHandThumb2Bind, ParentJoint = leftHandThumb2 },
                new JointPair { Joint = leftHandThumb3, ParentJoint = leftHandThumb2 },
                new JointPair { Joint = leftHandThumb3Bind, ParentJoint = leftHandThumb3 },
                new JointPair { Joint = leftShoulderBind, ParentJoint = leftShoulder },
                ...
                // new JointPair { Joint = centerPonytail0Dyn0, ParentJoint = face },
                // new JointPair { Joint = centerPonytail0Dyn1, ParentJoint = centerPonytail0Dyn0 },
                // new JointPair { Joint = centerPonytail0Dyn2, ParentJoint = centerPonytail0Dyn1 },
                new JointPair { Joint = faceBind, ParentJoint = face },
                new JointPair { Joint = jaw, ParentJoint = face },
                new JointPair { Joint = jawBind, ParentJoint = jaw },
                new JointPair { Joint = leftBrowBind, ParentJoint = face },
                new JointPair { Joint = leftEyeSocket, ParentJoint = face },
                new JointPair { Joint = leftEyeSocketBind, ParentJoint = leftEyeSocket },
                new JointPair { Joint = leftEye, ParentJoint = leftEyeSocket },
                new JointPair { Joint = leftEyeBind, ParentJoint = leftEye },
                new JointPair { Joint = mouthBind, ParentJoint = face },
                new JointPair { Joint = mouthInnerBind, ParentJoint = face },
                new JointPair { Joint = noseBind, ParentJoint = face },
                new JointPair { Joint = rightBrowBind, ParentJoint = face },
                new JointPair { Joint = rightEyeSocket, ParentJoint = face },
                new JointPair { Joint = rightEyeSocketBind, ParentJoint = rightEyeSocket },
                new JointPair { Joint = rightEye, ParentJoint = rightEyeSocket },
                new JointPair { Joint = rightEyeBind, ParentJoint = rightEye },
                ...
                new JointPair { Joint = rightArmTwist1Bind, ParentJoint = rightArm },
                new JointPair { Joint = rightArmTwist2Bind, ParentJoint = rightArm },
                new JointPair { Joint = rightArmTwist3Bind, ParentJoint = rightArm },
                new JointPair { Joint = rightForeArm, ParentJoint = rightArm },
                new JointPair { Joint = rightForeArmTwist1Bind, ParentJoint = rightForeArm },
                new JointPair { Joint = rightForeArmTwist2Bind, ParentJoint = rightForeArm },
                new JointPair { Joint = rightForeArmTwist3Bind, ParentJoint = rightForeArm },
                ...
                new JointPair { Joint = rightHandIndex1Bind, ParentJoint = rightHandIndex1 },
                new JointPair { Joint = rightHandIndex2, ParentJoint = rightHandIndex1 },
                new JointPair { Joint = rightHandIndex2Bind, ParentJoint = rightHandIndex2 },
                new JointPair { Joint = rightHandIndex3, ParentJoint = rightHandIndex2 },
                new JointPair { Joint = rightHandIndex3Bind, ParentJoint = rightHandIndex3 },
                new JointPair { Joint = rightHandMiddle1, ParentJoint = rightHandBind },
                new JointPair { Joint = rightHandMiddle1Bind, ParentJoint = rightHandMiddle1 },
                new JointPair { Joint = rightHandMiddle2, ParentJoint = rightHandMiddle1 },
                new JointPair { Joint = rightHandMiddle2Bind, ParentJoint = rightHandMiddle2 },
                new JointPair { Joint = rightHandMiddle3, ParentJoint = rightHandMiddle2 },
                new JointPair { Joint = rightHandMiddle3Bind, ParentJoint = rightHandMiddle3 },
                new JointPair { Joint = rightHandPinky1, ParentJoint = rightHandBind },
                new JointPair { Joint = rightHandPinky1Bind, ParentJoint = rightHandPinky1 },
                new JointPair { Joint = rightHandPinky2, ParentJoint = rightHandPinky1 },
                new JointPair { Joint = rightHandPinky2Bind, ParentJoint = rightHandPinky2 },
                new JointPair { Joint = rightHandPinky3, ParentJoint = rightHandPinky2 },
                new JointPair { Joint = rightHandPinky3Bind, ParentJoint = rightHandPinky3 },
                new JointPair { Joint = rightHandRing1, ParentJoint = rightHandBind },
                new JointPair { Joint = rightHandRing1Bind, ParentJoint = rightHandRing1 },
                new JointPair { Joint = rightHandRing2, ParentJoint = rightHandRing1 },
                new JointPair { Joint = rightHandRing2Bind, ParentJoint = rightHandRing2 },
                new JointPair { Joint = rightHandRing3, ParentJoint = rightHandRing2 },
                new JointPair { Joint = rightHandRing3Bind, ParentJoint = rightHandRing3 },
                new JointPair { Joint = rightHandThumb1, ParentJoint = rightHandBind },
                new JointPair { Joint = rightHandThumb1Bind, ParentJoint = rightHandThumb1 },
                new JointPair { Joint = rightHandThumb2, ParentJoint = rightHandThumb1 },
                new JointPair { Joint = rightHandThumb2Bind, ParentJoint = rightHandThumb2 },
                new JointPair { Joint = rightHandThumb3, ParentJoint = rightHandThumb2 },
                new JointPair { Joint = rightHandThumb3Bind, ParentJoint = rightHandThumb3 },
                new JointPair { Joint = rightShoulderBind, ParentJoint = rightShoulder },
                new JointPair { Joint = spine2Bind, ParentJoint = spine2 },
                new JointPair { Joint = spineBind, ParentJoint = spine },
            };

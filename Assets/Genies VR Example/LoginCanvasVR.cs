...
{
    public class LoginCanvasVR : MonoBehaviour
    {
        [Header("Scene References")]
        public LoadAndBecomeMyAvatar loadAndBecomeMyAvatar;
        ...
        private async void OpenAvatarEditor()
        {
            ...
            if (loadAndBecomeMyAvatar.LoadedAvatar is null)
            {
                Debug.LogWarning("An avatar must be loaded to open the Avatar Editor.");
            }

            await AvatarSdk.OpenAvatarEditorAsync(loadAndBecomeMyAvatar.LoadedAvatar);
        }
